---
name: query-graph
description: Query the 큽 banking products knowledge graph for product information, comparisons, and insights
---
...
1. **Neo4j 연결 확인**
   ```bash
   docker compose -f /Users/user01/Desktop/banking_bot/docker-compose.yml ps
   ```

2. **쿼리 실행** (Python 사용)
   ```python
   import sys
   sys.path.insert(0, "/Users/user01/Desktop/banking_bot")
