# 큽은행 금융상품 GraphRAG 챗봇

**큽은행 금융상품 지식그래프 & GraphRAG 기반 대화형 챗봇**

이 프로젝트는 큽은행의 금융상품 데이터를 수집하여 Neo4j 지식그래프로 구축하고, LangGraph 기반 에이전트와 GraphRAG 기술을 활용한 지능형 금융상품 상담 챗봇입니다. 1,233개 노드와 3,757개 관계로 이루어진 구조화된 지식그래프와 D3.js 기반 인터랙티브 시각화를 제공합니다.
...
- **웹 스크래핑**: Playwright를 활용한 큽은행 금융상품 자동 수집
...
```
큽은행 웹사이트 (https://bank.example.com/)
    ↓
...
- 큽은행 금융상품 163개 수집 (웹 스크래핑 + PDF 파싱)
...
**언어**: 한국어 / **프로젝트**: 큽은행 금융상품 GraphRAG 챗봇
